...
when@prod:
    ...
    NeuralGlitch\OmniaIpsum\:
        resource: '../vendor/neuralglitch/omnia-ipsum/src/*'
        exclude:
            - '../vendor/neuralglitch/omnia-ipsum/src/**'
```

## Configuration Validation

The bundle validates configuration automatically:
